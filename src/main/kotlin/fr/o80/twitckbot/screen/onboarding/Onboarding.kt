...
fun Onboarding(
    ...
    onCopyAuthorizationUrlClicked: (port: Int, clientId: String, clientSecret: String) -> Unit,
    ...
    Box(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Button(
                    onClick = {
                        onAuthorizationClicked(port.toInt(), clientId, clientSecret)
                    }
                ) {
                ...
                OutlinedButton(
                    onClick = {
                        onCopyAuthorizationUrlClicked(port.toInt(), clientId, clientSecret)
                    }
                ) {
                    Text("Copy URL")
                }
